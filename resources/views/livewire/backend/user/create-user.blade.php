                    ...
                    <div class="card mx-5">
                        <div class="card-body">
                            ...
                            <div class="text-right pt-3">
                                <button wire:click="store" wire:loading.attr="disabled" class="square-btn-success mr-2" title="Store">
                                    <span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span>
                                    <span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline">Save</span>
                                </button>
